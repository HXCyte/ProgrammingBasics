...
--Deskripsi : Menghapus elemen list yang memenuhi kondisi.
...
-- Menghapus elemen list yang memenuhi kondisi yang ditentukan oleh fungsi parameter
isLebih5 :: Int -> Bool
isBetween :: Int -> Bool
isEqual10:: Int -> Bool
...
deleteIf l f
    | isEmpty l = [] -- basis
    | f (head l) = deleteIf (tail l) f -- rekurens
    | otherwise = konso (head l) (deleteIf (tail l) f)
isLebih5 x = x > 5
